returnpotpareto<-function(pato,ret,w=1.65){
  ...
  #' @param w multiplier used to calculate a threshold probability
  #' @return percentile of the generalized Pareto distribution corresponding to a threshold probability calculated based on the pseudo return period
  #' @export
