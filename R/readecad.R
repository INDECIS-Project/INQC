readecad<-function(input="SS_STAID000143.txt",missing= -9999){
  ...
  #' Read an ECA&D data/sources/stations(?) file
  ...
  #' @param input the ECA&D filename
  ...
  #' @return a table of data read from ECA&D file (a header of ECA&D file is skipped)
  #' @export
  ...
  nyu<-nyu-1
  #OS. Commands above are only to define how many lines in the ECA&D file have to be skipped
